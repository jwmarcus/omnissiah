# Working on Omnissiah

This file orients an AI coding assistant (Claude Code, Codex, or similar) opened
in this folder. It is about changing the generator itself. It is not the
`CLAUDE.md` that ships to a generated repo; that one is `templates/CLAUDE.md.tmpl`.
